...
export default function Card({
  ...
  return (
    <article
      className={`card-shadow rounded-xl border border-ink/10 bg-paper p-7 transition-transform duration-200 hover:-translate-y-1 ${className}`}
    >
      {Icon ? (
      ...
      <h3 className="yellow-tick text-lg font-bold text-ink">{title}</h3>
